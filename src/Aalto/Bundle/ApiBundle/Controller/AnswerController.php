...
class AnswerController extends Controller
{
     ...
     *  },
     * )
     * @Route("/list/global/most_searched", name="aalto_api_answer_global_most_searched", methods={"GET"})
     *
     * @param Request $request
     *
     * @return JsonResponse
     ...
     *  },
     * )
     * @Route("/list/most_searched/{email}", name="aalto_api_answer_most_searched_user", methods={"GET"})
